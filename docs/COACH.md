...
The current coach is deterministic. It recognizes common questions in English,
...
is also deterministic and uses a small allowlist of tools. No hosted model is
